...
var headingPointer = document.getElementsByClassName('headingPointer');
var uiuxIcon = document.getElementsByClassName('uiuxIcon');
var mobileContactIcon = document.getElementsByClassName('mobileContactIcon');
var contactUsX = document.getElementsByClassName('contactUsX');
var popupSideMenu = document.getElementsByClassName('popupSideMenu');
...
function toogleContact() {
  if(contactUsToogle){
    ...
    popupSideMenu[0].style.background = '#000'

    headingPointer[0].style.opacity ='0';
    uiuxIcon[0].style.opacity ='0';
    setTimeout(function () {
      headingPointer[0].style.display = 'none';
      uiuxIcon[0].style.opacity ='1';
    }, 300);

    contactUsToogle = 0;
  }else{
    contcactUsContainerID.className = 'contactUsContainer contactUsContainerHide'
    popupSideMenuContainer[0].style.background = '#000';
    popupSideMenu[0].style.background = '#b088e5'

    uiuxIcon[0].style.opacity ='0';

    setTimeout(function () {
      headingPointer[0].style.display = 'block';
      headingPointer[0].style.opacity ='1';
      uiuxIcon[0].style.opacity ='1';
    }, 300);
...
mobileContactIcon[0].addEventListener('click',toogleContact);
contactUsX[0].addEventListener('click',toogleContact);
popupSideMenu[0].addEventListener('click',()=>{
  if(contactUsToogle === 0){
    toogleContact()
  }
});
// textarea
...
textarea.addEventListener('focus',()=>{
  textarea.className = 'focues'
})
textarea.addEventListener('focusout',()=>{
  textarea.className = 'unfocues'
})
...
function dotColorChange() {
  ...
  dotslideChange()
  imAdot[recentWorkStage].style.background = '#aaaaaa';
}
...
function dotColorChangeServices() {
  ...
  servicesDot[servicesWorkStage].style.background = '#aaaaaa';
}
